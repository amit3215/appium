...
module.exports = function(appium) {
  ...
  rest.post('/wd/hub/session/:sessionId/touch/pinchClose', controller.mobilePinchClose);
  rest.post('/wd/hub/session/:sessionId/touch/pinchOpen', controller.mobilePinchOpen);
